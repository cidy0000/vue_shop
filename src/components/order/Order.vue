   ...
   <!-- 面包屑导航区 -->
    ...
    <el-card>
        ...
        <el-table :data="orderlist" border stripe>
            ...
            <el-table-column label="订单编号" prop="ordr_number"></el-table-column>
            <el-table-column label="订单价格" prop="ordr_price"></el-table-column>
    ...
    <el-dialog title="修改地址" :visible.sync="addressVisible"
     ...
     ref="addressFormRef" label-width="100px">
      ...
      <el-cascader :options="cidyData" v-model="addressForm.address1">
    ...
    <!-- 展示物流进度对话框 -->
    <el-dialog title="物流进度" :visible.sync="progressVisble"
     width="50%">
    <!-- 时间线 -->
