                ...
                <el-row :class="['bdbottom', i1 === 0 ? 'bdtop' : '', 'vcenter']"
                    ...
                    <el-col :span="19">
                        ...
                        <el-row :class="[i2 === 0 ? 'bdtop' : '', 'vcenter']" v-for="(item2, i2) in item1.children" :key="item2.id">
                            <el-col type="success"  closable @close="removeRightById(scope.row, item2.id)">
                                   {{item2.authName}}
                            </el-col>
                            <i class="el-icon-caret-right"></i>
                        <el-col :span="18">
...
{{scope.row}}
    ...
    @click="showSteRightDialog(scope.row)">分配权限</el-button>
    </template>
    </el-table-column>
     </el-table>
 </el-card>
 ...
 <el-dialog
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="allotRights = false">确 定</el-button>
  </span>
</el-dialog>
<!-- 修改用户的对话框 -->
    ...
    role.children = res.data
       ...
       async showSteRightDialog(role) {
        ...
        getLeafKeys(node,arr) {
             //如果当前node节点不包含children 谁能够，则是三级节点
            if(!node.children){
