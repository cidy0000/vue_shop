  ...
  :before-leave="beforeTabLeave" @tab-click="tabClicked">
    <el-tab-pane label="基本信息" name="0">
        ...
        <el-form-item label="商品分类" prop="goods_cat">
            <el-cascader expand-trigger="hover" v-model="addForm.goods_cat"
    ...
    <el-checkbox-group v-model="item.attr_vals">
        <el-checkbox :label="cb" v-for="(cb, i) in
         item.attr_vals" :key="i" border>
        </el-checkbox>     
    </el-checkbox-group>
        </el-form-item>
    </el-tab-pane>
    ...
    <el-tab-pane label="商品内容" name="4">
         ...
         <!-- 添加商品的按钮 -->
         <el-button type="primary" class="btnAdd" @click="add"></el-button>
    </el-tab-pane>
  </el-tabs>
 </el-form>
    </el-card>
...
export default {
    ...
    //    处理移除图片的操作
       handleRemove(file) {
        ...
        // 3.调用数组的  splice方法，把图片信息对象，从pics 数组中移除
    ...
    //    监听图片上传成功的事件
       handleSuccess(response) {
        ...
        this.addForm.pics.push(pixInfo)
        console.log(this.addForm)
       },
    //    添加商品
       add() {
